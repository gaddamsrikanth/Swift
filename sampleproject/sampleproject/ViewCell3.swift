...
protocol ViewCell3Delegate : NSObjectProtocol {
    func swipeableTableViewCellDidRecognizeSwipe(cell : ViewCell3)
    func swipeableTableViewCellDidTapLeftButton(cell : ViewCell3)
    func swipeableTableViewCellDidTapRightButton(cell : ViewCell3)
}

class ViewCell3: UITableViewCell {
    weak var delegate : ViewCell3Delegate?
