...
class AlamJsonController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet var tableView: UITableView!
        override func viewDidLoad() {
            ...
            request("http://api.androidhive.info/contacts/").responseJSON { (responseData) -> Void in
